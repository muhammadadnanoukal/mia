    ...
    def edit_recipe(self, recipe_id:int, vals:dict):
        ...
        try:
            ...
            if recipe:
                ...
                new_recipe_vals = {}
                if str(vals.get('recipe_image')).find('AssetImage') == 0:
                    new_recipe_vals['image_1920'] = vals.get('recipe_image')
                if str(vals.get('recipe_image1')).find('AssetImage') == 0:
                    new_recipe_vals['image_1920_1'] = vals.get('recipe_image')
                if str(vals.get('recipe_image2')).find('AssetImage') == 0:
                    new_recipe_vals['image_1920_2'] = vals.get('recipe_image')
